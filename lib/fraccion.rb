# Practica 7 Lenguajes y Paradigmas de la Programación
# Desarrollo Dirigido por el Comportamiento por pruebas (Test Driven Development - TDD) usando como herramienta Rspec
...
class Fraccion
				#Realizando modificaciones oportunas para contemplar el uso del módulo comparable.
	include Comparable
